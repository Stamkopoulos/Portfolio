      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="flex gap-4">
            ...
            >
              <button className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md bg-indigo-900 px-6 font-medium text-gray-100">
            ...
            <a href="#contact" className="border border-white/10 rounded-lg">
              <button className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md bg-gray-800 px-6 font-medium text-gray-200 duration-500">
